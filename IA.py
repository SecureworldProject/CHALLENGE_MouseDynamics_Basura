...
logdir = "logs/plots6/" + datetime.now().strftime("%Y%m%d-%H%M%S")
...
Y_train.append([5])
print(len(X_train))
X_train=np.load("datos2/5002.npy")
aux=np.zeros(shape=[4000,2])
aux[0:len(X_train)]=X_train
X_trainf.append(aux)
Y_train.append([5])
print(len(X_train))
X_train=np.load("datos2/5003.npy")
aux=np.zeros(shape=[4000,2])
aux[0:len(X_train)]=X_train
X_trainf.append(aux)
Y_train.append([5])
print(len(X_train))
X_train=np.load("datos2/5004.npy")
aux=np.zeros(shape=[4000,2])
aux[0:len(X_train)]=X_train
X_trainf.append(aux)
Y_train.append([5])
print(len(X_train))
X_train=np.load("datos2/5005.npy")
aux=np.zeros(shape=[4000,2])
aux[0:len(X_train)]=X_train
X_trainf.append(aux)
Y_train.append([5])
print(len(X_train))
X_train=np.load("datos2/5006.npy")
aux=np.zeros(shape=[4000,2])
aux[0:len(X_train)]=X_train
X_trainf.append(aux)
Y_train.append([5])
print(len(X_train))
X_train=np.load("datos2/5007.npy")
aux=np.zeros(shape=[4000,2])
aux[0:len(X_train)]=X_train
X_trainf.append(aux)
Y_train.append([5])
print(len(X_train))
X_train=np.load("datos2/5008.npy")
aux=np.zeros(shape=[4000,2])
aux[0:len(X_train)]=X_train
X_trainf.append(aux)
Y_train.append([5])
print(len(X_train))
X_train=np.load("datos2/5009.npy")
aux=np.zeros(shape=[4000,2])
aux[0:len(X_train)]=X_train
X_trainf.append(aux)
Y_train.append([5])
